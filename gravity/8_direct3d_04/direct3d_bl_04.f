...
c
c
c       v 2.0 change origin by subtracting all coord values from 1.0
c       *******************************************************************************
        INCLUDE 'head_04.def'
        include 'config.defs'
...
c       start here - keep in mind pos of 3-D sig "cloud" in same plot
c       e.g., "cloud" of 100 final points for all 100 control datasets!!
c
c
c
c       z-axis is distance between particles in pair
